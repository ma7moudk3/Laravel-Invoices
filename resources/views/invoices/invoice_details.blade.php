                            ...
                            <div class="tab-menu-heading">
                                <div class="tabs-menu ">
                                    ...
                                    <ul class="nav panel-tabs">
                                        ...
                                        <li><a href="#tab12" data-toggle="tab"><i class="fa fa-cube"></i>حالة
                                                الفاتورة</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <a class="btn btn-outline-success btn-sm"
                                                           href="{{ url('invoices/viewFile') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"
                                                           role="button"><i class="fas fa-eye"></i>&nbsp;
                                                            عرض</a>

                                                        <a class="btn btn-outline-info btn-sm"
                                                           href="{{ url('invoices/downloadFile') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"
                                                           role="button"><i
    ...
    <div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('invoices.delete.file') }}" method="post">
